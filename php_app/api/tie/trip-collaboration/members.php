...
try {
    ...
    $planId = UthengaTiePlanContracts::planId(UthengaTieApi::query());
    UthengaTieApi::respond(['success' => true, 'request_id' => $requestId, 'result' => (new UthengaTieKernel())->tripCollaboration->members($planId, $user['id'])]);
