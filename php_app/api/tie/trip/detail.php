...
try {
    ...
    $tripId = UthengaTieTripEngineContracts::tripId($_GET['id'] ?? null);
    UthengaTieApi::respond(['success' => true, 'request_id' => $requestId, 'detail' => (new UthengaTieKernel())->trips->detail($tripId, $user['id'])]);
