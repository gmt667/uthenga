...
if ($existingUser) {
    ...
    dbExecute(
        ...
        [$userId, $googleName, $userRole, 'Google OAuth Registration',
         "New " . strtolower($userRole) . " account via Google OAuth: $googleEmail"]
    );
    ...
    if ($userRole === ROLE_VENDOR) {
        try {
            dbExecute(
                ...
                [$userId, $googleName, null, null, null, 'Other', 'Vendor account created via Google OAuth', 'pending']
            );
        } catch (Throwable $e) {
