...
function createInlineSvgIcon(name) {
  const icons = {
    ...
    clock: '<path d="M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18zm1 9.4 3.2 1.9-.9 1.5L11 13V7h2z" fill="currentColor"/>',
    users: '<path d="M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm6.5 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM3 19a6 6 0 0 1 12 0H3zm11.8 0a5.6 5.6 0 0 0-1.3-3.5 5 5 0 0 1 7.5 3.5h-6.2z" fill="currentColor"/>',
    building: '<path d="M4 21V3h12v18h-3v-3H7v3zm3-5h4v-2H7zm0-4h4v-2H7zm0-4h4V6H7zm12-2h-4v18h4V8h1V6a2 2 0 0 0-2-2z" fill="currentColor"/>',
    rocket: '<path d="M13 3c3.5.2 5.8 2.5 6 6l2 2-4 1-3 3-1 4-2-2-2-2-4 1 1-4 3-3 1-4 3-2z" fill="currentColor"/>',
    bell: '<path d="M12 2a5 5 0 0 0-5 5v3.2c0 .7-.3 1.4-.8 2L4.5 14v1h15v-1l-1.7-1.8c-.5-.6-.8-1.3-.8-2V7a5 5 0 0 0-5-5zm-1 18a2 2 0 0 0 2-2h-4a2 2 0 0 0 2 2z" fill="currentColor"/>',
